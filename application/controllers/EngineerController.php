	     ...
	     if($this->input->post('add_enginner'))
			...
			/*  $Eng_permi_data=array('engineer_id'=>$insert_id,'Supervisor'=>$eng_p1,'Operative'=>$eng_p2,'All_orders'=>$eng_p3,'Orders_to_Approve'=>$eng_p4,'See_costs'=>$eng_p5,'limit_order_per_day'=>$opd,'single_order_limit'=>$sopd,'status_meterial_cost'=>$met_co,'Categories'=>$eng_p6,'Orders'=>$eng_p7,'Project_details'=>$eng_p8,'Catalogues'=>$eng_p10,'AddProduct'=>$eng_p11,'Wholeseller'=>1); */
			 if($insert)
			 {
					 ...
					 {
					  $Eng_permi_data=array('engineer_id'=>$insert_id,'Supervisor'=>$eng_p1,'Operative'=>$eng_p2,'All_orders'=>$eng_p3,'Orders_to_Approve'=>$eng_p4,'See_costs'=>$eng_p5,'limit_order_per_day'=>$opd,'single_order_limit'=>$sopd,'status_meterial_cost'=>$met_co,'Categories'=>$eng_p6,'Orders'=>$eng_p7,'Project_details'=>$eng_p8,'Catalogues'=>$eng_p10,'AddProduct'=>$eng_p11,'Wholeseller'=>0);
					 }
		...
		/***Permission*****/
		 ...
		 $sopd=$this->input->post('single_order_per_day');
				...
				$sopd='100000';
				 ...
				 $Eng_permi_data=array('Supervisor'=>$eng_p1,'Operative'=>$eng_p2,'All_orders'=>$eng_p3,'Orders_to_Approve'=>$eng_p4,'See_costs'=>$eng_p5,'limit_order_per_day'=>$opd,'single_order_limit'=>$sopd,'Categories'=>$eng_p6,'Orders'=>$eng_p7,'Project_details'=>$eng_p8,'Catalogues'=>$eng_p10,'AddProduct'=>$eng_p11,'Wholeseller'=>$wholesell);
