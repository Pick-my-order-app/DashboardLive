...
class OrdersController extends CI_Controller {
	...
	if(!$Enid=='0'){
	   ...
	   array_push($emptyarray,array('id'=>$or['id'],'total_ex_vat'=>$or['total_ex_vat'],'date'=>$or['date'],'po_reffrence'=>$or['po_reffrence'],'total_inc_vat'=>$or['total_inc_vat'],'status'=>$or['status'],'engineer_id'=>$or['engineer_id'],'supplier_id'=>$or['supplier_id'],'odrdescrp'=>$or['odrdescrp'],'po_number'=>$or['po_number']));
	   }
