  ...
  public function Adminloginbysuperadmin()
  {
	...
	public function business()
	{
		if($this->input->post('Insert_Busi'))
		{
			...
			$App_status= $this->input->post('app_active_status');
	...
	public function Editbusiness()
	{
		...
		if($this->input->post('update_Busi'))
		{
			...
			if(isset($_FILES['business_logo']))
			{
				...
				$image_url=$this->UpdateUrlMethod().'/images/applogo/'.$image_name_1;
				$image_url=str_replace(' ', '',$image_url);
			    move_uploaded_file($image["tmp_name"],"images/applogo/".$image_name_1);
            }
			else
			{
				$image_url= $this->input->post('business_url');
			}
