...
/***********************************************************************************************************************/
				...
				{
					echo json_encode(array("statusCode"=>200,"valid"=>true,"Message"=>"Login Success",'role'=>$role,'id'=>$userid,'user name'=>$username,'image'=>$userimage,"Categorie"=>$Categorie,"Orders"=>$Orders,"Project_Details"=>$Project_Details,"Catalogues"=>$Catalogues,"All_Orders"=>$All_Orders,'Orders_To_approve'=>$Orders_To_approve,'Seecost'=>$See_Cost,'numberofawating'=>$numberofawating,$device_id,"Business_id"=>$business_id,'Addproduct'=>$Addproduct,'permission_wholeseller'=>$permission_wholeseller,'Wholeseller_engineer_id'=>$main_id,'BussinessName'=>$busi_name,'first_name'=>$firstname,'last_name'=>$lastname,'ViewWholesellerPage'=>$Haveornot,'publishKey'=>$key));
				}
				else	
				{
